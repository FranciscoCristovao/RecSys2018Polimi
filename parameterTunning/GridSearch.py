...
from parameterTunning.AbstractClassSearch import AbstractClassSearch, DictionaryKeys
...
class GridSearch(AbstractClassSearch):
    ...
    def runSingleCase(self, paramether_dictionary, dictionary, folderPath = None, namePrefix = None):
        ...
        try:
            ...
            return recommender.evaluateRecommendations(self.URM_validation, at=10, mode="parallel")

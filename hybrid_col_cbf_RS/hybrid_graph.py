...
class HybridRS:
    ...
    def recommend(self, playlist_ids, alpha=0.1, beta=1, gamma=1, delta=2, omega=30, theta=1, filter_top_pop=False):
        ...
        e_r_p3alpha = self.p3alpha.get_estimated_ratings()
        ...
        print("graph")
        print(e_r_p3alpha[7].data[e_r_p3alpha[7].data.argsort()[::-1]])
        ...
        estimated_ratings_final = estimated_ratings_aux3 + e_r_p3alpha.multiply(theta)

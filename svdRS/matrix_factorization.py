...
from svdRS.Cython.MF_RMSE import FunkSVD_sgd, AsySVD_sgd, AsySVD_compute_user_factors, BPRMF_sgd
...
class FunkSVD:
    ...
    def fit(self, num_factors=210, learning_rate=0.01, reg=0.015, epochs=100, init_mean=0.0, init_std=0.1,
            lrate_decay=1.0, rnd_seed=42):
        """
    ...
    def recommend(self, user_id, at=10, n=None, exclude_seen=True, filterTopPop = False, filterCustomItems = False):
        if n is None:
